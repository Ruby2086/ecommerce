                            ...
                            <div className='filter-card mb-3'>
                                ...
                                <div>
                                    <div className="random-products d-flex mb-3">
                                        <div className='w-50'>
                                            <img src={require("../images/headphone.jpg")} alt="watch" className='img-fluid' />
                                        </div>
                                        <div className='w-50'>
                                            <h5>
                                    ...
                                    <div className="random-products d-flex mb-3">
                                        <div className='w-50'>
                                            <img src={require("../images/watch.jpg")} alt="watch" className='img-fluid' />
                                        </div>
                                        <div className='w-50'>
                                            <h5>
                                                Kids Headphone Bulk 10 pack Multi colored for students
                               ...
                               <div className="d-flex align-items-center gap-10">
                                ...
                                <div className='d-flex align-items-center gap-10'>
                                    ...
                                    <div className="d-flex gap-10 align-items-center grid">  
                                            <img onClick={()=>{setGrid(3)}} src={require("../images/gr4.svg")} className='d-block img-fluid' alt="grid" />
                                            <img onClick={()=>{setGrid(4)}} src={require("../images/gr3.svg")} className='d-block img-fluid' alt="grid" />
                                            <img onClick={()=>{setGrid(6)}} src={require("../images/gr2.svg")} className='d-block img-fluid' alt="grid" />
                                            <img onClick={()=>{setGrid(12)}} src={require("../images/gr.svg")} className='d-block img-fluid' alt="grid" />    
                                           {/** <img onClick={()=>{setGrid(3)}} src={require("../images/watch.jpg")} className='d-block img-fluid' alt="grid" /> 
                                            <img onClick={()=>{setGrid(3)}} src={require("../images/watch.jpg")} className='d-block img-fluid' alt="grid" /> 
                                            <img onClick={()=>{setGrid(3)}} src={require("../images/watch.jpg")} className='d-block img-fluid' alt="grid" /> 
                                            <img onClick={()=>{setGrid(3)}} src={require("../images/watch.jpg")} className='d-block img-fluid' alt="grid" />  */} 
                                    </div>  
